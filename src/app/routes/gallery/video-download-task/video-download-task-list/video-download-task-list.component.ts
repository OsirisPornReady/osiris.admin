...
export class GalleryVideoDownloadTaskListComponent implements OnInit {
  ...
  columns: STColumn[] = [
    ...
    { title: '文件数量', index: 'torrentInfo.torrent_files', className: 'text-center' },
    { title: '总大小', index: 'torrentInfo.torrent_size', className: 'text-grey' },
    { title: '磁链时间', index: 'torrentInfo.torrent_age', className: 'text-success' },
    { title: '视频文件', index: 'torrentInfo.torrent_excerpt', width: 300, render: 'customTorrentExcerpt', className: 'text-volcano' },
    { title: '视频大小', index: 'torrentInfo.torrent_excerpt_size', className: 'text-blue' },
